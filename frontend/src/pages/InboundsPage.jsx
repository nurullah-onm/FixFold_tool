...
const texts = {
  tr: {
    title: 'Giri?ler (Inbound)',
    desc: 'Giri? (Inbound), Xray?in hangi port/protokolden trafik kabul edece?ini tan?mlar. TLS/Reality gerekiyorsa ilgili alanlar? doldurun.',
    createTitle: 'Giri? (Inbound) Olu?tur',
    listTitle: 'Mevcut Giri?ler',
    none: 'Giri? bulunamad?.',
    created: 'Giri? (Inbound) olu?turuldu.',
    createFail: 'Giri? olu?turulamad?',
    listFail: 'Giri? listesi al?namad?',
    refresh: 'Yenile',
    name: 'Ad / Remark',
    protocol: 'Protokol',
    port: 'Port',
    listen: 'Dinleme IP',
    tag: 'Tag',
    network: '?letim (Network)',
    security: 'G?venlik',
    firstEmail: '?lk client email (opsiyonel)',
    totalFlows: 'Toplam Ak??',
    resetDay: 'Trafik S?f?rlama (g?n)',
    duration: 'S?re (g?n)',
    auth: 'Authentication',
    ...
    httpObf: 'HTTP Kand?rma (Host/Path)',
    wsHost: 'WS Host',
    wsPath: 'WS Path',
